...
//        Spacer(modifier = Modifier.height(20.dp))
        Text("📰 Personal News App - Modern News Reader App", fontSize = 22.sp, fontWeight = FontWeight.Bold)
        Spacer(modifier = Modifier.height(8.dp))
        Text("Personal New App is a personalized news reader app built using Jetpack Compose and Kotlin. It offers a clean, swipe-based interface like Inshorts, with Google Sign-In, location tracking, image upload, offline support, and notifications – all powered by modern Android architecture.")

        Spacer(modifier = Modifier.height(16.dp))
        Text("🚀 Features", fontSize = 20.sp, fontWeight = FontWeight.SemiBold)

        FeatureSection(title = "🔐 Authentication", items = listOf(
...
fun FeatureSection(title: String, items: List<String>) {
    ...
    items.forEach { item ->
        Text("• $item", fontSize = 14.sp, modifier = Modifier.padding(start = 8.dp, bottom = 2.dp))
    }
}